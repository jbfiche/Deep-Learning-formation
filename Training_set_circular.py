...
The training data is defined as an array 
"""

# Definition of a training data where the two classes are simply defined by either d>5 or d<5
# --------------------------------------------------------------------------------------------
   
def Training_set_circular(radius,N):
